...
//        4x3        4         no        12x4       4            0            no              no
    ...
    /// - Returns: The modified layer
    public func weightOptimizer(_ optimizer: LearningOptimizer) -> FullyConnectedLayer {
    ...
    /// - Returns: The modified layer
    public func weightLearningOptions(_ options: LearningOptions) -> FullyConnectedLayer {
    ...
    /// - Returns: The modified layer
    public func biasOptimizer(_ optimizer: LearningOptimizer) -> FullyConnectedLayer {
    ...
    /// - Parameter options: The LearningOptions structure with all the learning options
    /// - Returns: The modified layer
    public func biasLearningOptions(_ options: LearningOptions) -> FullyConnectedLayer {
