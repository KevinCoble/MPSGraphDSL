...
public class BatchNormalization : UnaryNode {
    ...
    public func learnWithRespectTo(_ lossNode: String) -> BatchNormalization {
    ...
    /// - Returns: The modified layer
    public func gammaOptimizer(_ optimizer: LearningOptimizer) -> BatchNormalization {
    ...
    /// - Returns: The modified layer
    public func gammaLearningOptions(_ options: LearningOptions) -> BatchNormalization {
    ...
    /// - Returns: The modified layer
    public func betaOptimizer(_ optimizer: LearningOptimizer) -> BatchNormalization {
    ...
    /// - Parameter options: The LearningOptions structure with all the learning options
    /// - Returns: The modified layer
    public func betaLearningOptions(_ options: LearningOptions) -> BatchNormalization {
